...
/// 버튼 30x30 세로 스택, 로고/드래그 핸들 34x34 원형. 치수는 <see cref="ShellMetrics"/>,
/// 활성 강조색은 <see cref="ShellPalette.Accent"/>가 소유한다 (로고만 브랜드 색).
...
public sealed class ToolbarWindow : Window
{
    ...
    {
        // 같은 도구 재선택 시 해제 — 판정은 ToolbarStateMap.ToggleTool (플라이아웃 항목 ToolbarFlyouts.SelectTool·도구 핫키 ShellHotkeys.SelectTool과 동일).
